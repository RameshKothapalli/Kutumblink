...
class TodoList {
    ...
    fileprivate let ITEMS_KEY = "KutumblinktodoItems"
    ...
    func allItems() -> [TodoItem] {
        ...
        return items.map({
            ...
            return TodoItem(deadline: item["deadline"] as! Date, title: item["title"] as! String, UUID: item["UUID"] as! String!,description:item["description"] as! String,contacts:item["contacts"] as! String)
